...
public class Querybpmn {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ProcessDefinition processDefinition = list.get(0);//获取一个流程实例
        //通过流程定义信息，获取到部署ID
      ...
      //8.构建出OutputStream流
        OutputStream pngOs =
                new FileOutputStream("E:\\active-demo\\src\\file\\"+processDefinition.getDiagramResourceName());

        OutputStream bpmnOs =
                new FileOutputStream("E:\\active-demo\\src\\file\\"+processDefinition.getResourceName());
