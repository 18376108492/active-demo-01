 ...
 * 排他网关测试用例
 */
public class ExclusiveGateWayDemo01 {
...
//                .deploy();
        ...
        Deployment deploy = repositoryService.createDeployment()
                .addClasspathResource("diagram/demo02/leave.bpmn")
        ...
        //创建流程实例
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("leave02", map);
